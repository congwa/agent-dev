...
- 它的迁移目录里有 **239 个 SQL 迁移文件**[^1]，能看到一个系统的 schema 是怎么长大的，以及在线 DDL 该怎么写。
...
[^1]: sub2api 仓库 `backend/migrations/` 目录，239 个 SQL 迁移文件，2026-08-04 核对。
[^2]: sub2api 余额扣减 SQL，出自 `backend/internal/repository/usage_billing_repo.go`，完整解释见第 3 篇。
